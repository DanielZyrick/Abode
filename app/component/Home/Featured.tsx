...
export default function Featured() {
  ...
  return (
    <div className="relative max-w-[1440px] m-auto px-5 md:px-10">
              ...
              <div className="flex flex-col gap-y-2">
                ...
                <div className="flex flex-col md:flex-row gap-x-5">
                  <div className="flex gap-x-2 items-center">
                    <BedDouble />
                    <span className="text-sm">{data.bed} Bedroom</span>
                  </div>
                  <div className="flex gap-x-2 items-center">
                    <LandPlot />
                    <span className="text-sm">{data.lotArea} Lot Area</span>
                  </div>
                  <div className="flex gap-x-2 items-center">
                    <Grid2X2 />
                    <span className="text-sm">{data.floorArea} Floor Area</span>
                  </div>
                </div>
              </div>
      ...
      <div className="text-center mt-16 w-full">
        <button className="w-full md:w-1/4 h-12 bg-black text-white rounded-xl">
          View Listings
        </button>
      </div>
    </div>
